  ...
  return (
    <>
      <div className="sticky top-0 left-0 w-full z-50">
        <header className="px-4 bg-white dark:bg-[#100c18] flex items-center min-h-12 md:min-h-16 border-b border-primary-border ">
              ...
              {navItems.map((nav, idx) => {
                return (
                  <li key={idx} className={``}>
                    <Link
                      href={nav.href}
                      className="font-semibold hover:opacity-80  whitespace-nowrap text-[18px] text-[#F2F2F3]"
                    >
                      {nav.label}
                    </Link>
                  </li>
        ...
        <div className="bg-white dark:bg-[#100c18] border-primary-border border-black">
